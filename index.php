          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="centered"><img class="img-circle" width="80" src="img/bal.jpeg"></p>
              ...
              <div class="modal-footer centered">
                ...
                <input type="submit" name="login" class="btn btn-theme03" value="LOGIN">
